...
class Ui_QuestionWindow(object):
    def setupUi(self, QuestionWindow, data_file, show_ans, is_timer, num_questions):
        ...
        self.label_question = QtWidgets.QTextEdit(self.verticalLayoutWidget)
        self.label_question.setReadOnly(True)
    ...
    def next_question(self):
        ...
        if self.curent_ques_number==self.num_questions-1 and self.test_On:
            ...
            # elif self.curent_ques_number==self.num_questions-1:self.pushButton_next.setText("End Test")
    ...
    def previous_question(self):
        ...
        #change label to new question in position self.curent_ques_number
        self.update_question()
        #button_control replace this line below
    ...
    def button_control(self):
       #previous button
        if self.curent_ques_number==0:
            self.pushButton_previous.setText("No Previous")
            self.pushButton_previous.setEnabled(False)
        elif self.curent_ques_number==1:
            self.pushButton_previous.setText("Previous Question")
            self.pushButton_previous.setEnabled(True)
        #next button 
        if self.curent_ques_number==self.num_questions-1:
            self.pushButton_next.setText("End Test")
            if not self.test_On:self.pushButton_next.setEnabled(False)
        elif self.curent_ques_number==self.num_questions-2:
            self.pushButton_next.setText("Next Question")  
            self.pushButton_next.setEnabled(True)
    ...
    def call_result_window(self):
        self.Ui_Results_windows = QtWidgets.QMainWindow()
        self.ui = Ui_Results()
        self.ui.setupUi(self.Ui_Results_windows,self.QuestionWindow,self.quiz_data,self.UserAnswer)
        self.Ui_Results_windows.show()
